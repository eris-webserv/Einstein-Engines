...
namespace Content.Server._EE.Iterasm.Binds
{
    public static partial class Interop
    {
        ...
        static Interop()
        {
            ...
            if (api_version != 0xcdffe28143870883)
            {
                throw new TypeLoadException($"API reports hash 0x{api_version:X} which differs from hash in bindings (0xcdffe28143870883). You probably forgot to update / copy either the bindings or the library.");
            }
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveOptimization)]
        public static partial ResultVoid state_incr(IntPtr state);


        [LibraryImport(NativeLib, EntryPoint = "state_get")]
        [MethodImpl(MethodImplOptions.AggressiveOptimization)]
        public static partial ResultI64Void state_get(IntPtr state, ushort index);


        [LibraryImport(NativeLib, EntryPoint = "state_set")]
        [MethodImpl(MethodImplOptions.AggressiveOptimization)]
        public static partial ResultVoid state_set(IntPtr state, ushort index, long new_value);


        [LibraryImport(NativeLib, EntryPoint = "state_alloc")]
        [MethodImpl(MethodImplOptions.AggressiveOptimization)]
        public static partial ResultU64Void state_alloc(IntPtr state, ulong len);
    ...
    ///Result that contains value or an error.
    public partial struct ResultI64Void
    {
        uint _variant;
        long _Ok;
    }
    ...
    public partial struct ResultI64Void
    {
        ...
        public unsafe struct Unmanaged
        {
            ...
            [MethodImpl(MethodImplOptions.AggressiveOptimization)]
            internal ResultI64Void ToManaged()
            {
                var _managed = new ResultI64Void();
                _managed._variant = _variant;
                if (_variant == 0) _managed._Ok = _Ok._Ok;
                return _managed;
            }
        ...
        public static ResultI64Void Ok(long value) => new() { _variant = 0, _Ok = value };
        public static ResultI64Void Err => new() { _variant = 1 };
        public static ResultI64Void Panic => new() { _variant = 2 };
        public static ResultI64Void Null => new() { _variant = 3 };
        ...
        [CustomMarshaller(typeof(ResultI64Void), MarshalMode.Default, typeof(Marshaller))]
        private struct MarshallerMeta { }

        public ref struct Marshaller
        {
            private ResultI64Void _managed;
            private Unmanaged _unmanaged;

            [MethodImpl(MethodImplOptions.AggressiveOptimization)]
            public Marshaller(ResultI64Void managed) { _managed = managed; }

            [MethodImpl(MethodImplOptions.AggressiveOptimization)]
            public Marshaller(Unmanaged unmanaged) { _unmanaged = unmanaged; }

            [MethodImpl(MethodImplOptions.AggressiveOptimization)]
            public void FromManaged(ResultI64Void managed) { _managed = managed; }
            ...
            [MethodImpl(MethodImplOptions.AggressiveOptimization)]
            public ResultI64Void ToManaged() { return _unmanaged.ToManaged(); }
    ...
    ///Result that contains value or an error.
    public partial struct ResultU64Void
    {
        uint _variant;
        ulong _Ok;
    }
    ...
    public partial struct ResultU64Void
    {
        ...
        public unsafe struct Unmanaged
        {
            ...
            [MethodImpl(MethodImplOptions.AggressiveOptimization)]
            internal ResultU64Void ToManaged()
            {
                var _managed = new ResultU64Void();
                _managed._variant = _variant;
                if (_variant == 0) _managed._Ok = _Ok._Ok;
                return _managed;
            }
        ...
        public static ResultU64Void Ok(ulong value) => new() { _variant = 0, _Ok = value };
        public static ResultU64Void Err => new() { _variant = 1 };
        public static ResultU64Void Panic => new() { _variant = 2 };
        public static ResultU64Void Null => new() { _variant = 3 };
        ...
        [CustomMarshaller(typeof(ResultU64Void), MarshalMode.Default, typeof(Marshaller))]
        private struct MarshallerMeta { }

        public ref struct Marshaller
        {
            private ResultU64Void _managed;
            private Unmanaged _unmanaged;

            [MethodImpl(MethodImplOptions.AggressiveOptimization)]
            public Marshaller(ResultU64Void managed) { _managed = managed; }

            [MethodImpl(MethodImplOptions.AggressiveOptimization)]
            public Marshaller(Unmanaged unmanaged) { _unmanaged = unmanaged; }

            [MethodImpl(MethodImplOptions.AggressiveOptimization)]
            public void FromManaged(ResultU64Void managed) { _managed = managed; }
            ...
            [MethodImpl(MethodImplOptions.AggressiveOptimization)]
            public ResultU64Void ToManaged() { return _unmanaged.ToManaged(); }
